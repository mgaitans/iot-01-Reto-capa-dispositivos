...
ALLOWED_HOSTS = ["localhost", "44.197.182.183"]
#"localhost", "ip.maquina.visualizador"
...
DATABASES = {
    "default": {
        ...
        "HOST": "34.201.12.111",  # Dirección IP de la base de datos ip.maquina.db
...
# Dirección del bróker MQTT ip.maquina.mqtt
MQTT_HOST = "54.157.122.172"   
