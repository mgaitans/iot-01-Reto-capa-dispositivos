...
int ValueRead=2;
int myflag=0;
int LDR_pin=0;  //leemos el pin analogico en 0
int LDR_var=0;  //Variable para leer datos del LDR
...
const char ssid[] = "PAKITA"; // TODO cambiar por el nombre de la red WiFi
// Contraseña de la red WiFi
const char pass[] = "Pakis4523"; // TODO cambiar por la contraseña de la red WiFi
...
const char MQTT_HOST[] = "44.204.137.108"; // TODO Reemplace ip.maquina.mqtt por la IP del bróker MQTT que usted desplegó. Ej: 192.168.0.1
...
/**
 * Lee la Luminosidad del sensor, la imprime en consola y la devuelve.
 */
